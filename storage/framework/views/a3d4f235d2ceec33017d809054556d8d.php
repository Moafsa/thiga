...
<form action="<?php echo e(route('vehicles.update', $vehicle)); ?>" method="POST" style="background-color: var(--cor-secundaria); padding: 30px; border-radius: 15px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 30px;">
        <div>
            ...
            <input type="number" name="fuel_consumption_per_km" value="<?php echo e(old('fuel_consumption_per_km', $vehicle->getFuelConsumptionKmPerLiter())); ?>" step="0.01" min="0" max="50"
        ...
        <div>
            ...
            <input type="number" name="tank_capacity" value="<?php echo e(old('tank_capacity', $vehicle->tank_capacity)); ?>" step="0.01" min="0"
                   placeholder="Ex: 100"
                   style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: var(--cor-principal); color: var(--cor-texto-claro);">
