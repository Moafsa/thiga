                    ...
                    <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 8px;">
                        <h4 style="color: var(--cor-texto-claro); margin: 0; font-size: 1em;">
                            ...
                            <?php if(($shipment->shipment_type ?? 'delivery') === 'pickup'): ?>
                                Coleta <?php echo e($index + 1); ?>

                            <?php else: ?>
                                Entrega <?php echo e($index + 1); ?>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(60px, 1fr)); gap: 8px;">
                            <?php $__currentLoopData = $shipment->deliveryProofs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $proof->photo_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photoUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($photoUrl): ?>
                                        <div style="position: relative; aspect-ratio: 1; border-radius: 6px; overflow: hidden; background: var(--cor-principal); border: 2px solid <?php echo e($proof->proof_type === 'pickup' ? '#FFD700' : '#4CAF50'); ?>;">
                        ...
                        <?php $__currentLoopData = $shipment->deliveryProofs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($proof->delivery_time): ?>
                                <p style="color: rgba(245, 245, 245, 0.6); font-size: 0.75em; margin-top: 5px;">
                                    <i class="fas fa-<?php echo e($proof->proof_type === 'pickup' ? 'hand-holding' : 'check-circle'); ?>"></i> 
                                    <?php echo e($proof->proof_type === 'pickup' ? 'Coletado' : 'Entregue'); ?> em <?php echo e($proof->delivery_time->format('d/m/Y H:i')); ?>
                ...
                <div style="display: flex; justify-content: space-between; align-items: start;">
                    <div style="flex: 1;">
                        ...
                        <div style="margin-top: 10px; display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                            ...
                            <span class="status-badge" style="background-color: <?php echo e(($shipment->shipment_type ?? 'delivery') === 'pickup' ? 'rgba(255, 215, 0, 0.2)' : 'rgba(76, 175, 80, 0.2)'); ?>; color: <?php echo e(($shipment->shipment_type ?? 'delivery') === 'pickup' ? '#FFD700' : '#4caf50'); ?>; font-size: 0.85em;">
                                <i class="fas fa-<?php echo e(($shipment->shipment_type ?? 'delivery') === 'pickup' ? 'hand-holding' : 'truck'); ?>"></i> 
                                <?php echo e(($shipment->shipment_type ?? 'delivery') === 'pickup' ? 'Coleta' : 'Entrega'); ?>
                        ...
                        <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid rgba(255,255,255,0.1);">
                            ...
                            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(100px, 1fr)); gap: 10px; margin-bottom: 10px;">
                                <?php $__currentLoopData = $shipment->deliveryProofs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $proof->photo_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photoUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($photoUrl): ?>
                                            <div style="position: relative; aspect-ratio: 1; border-radius: 8px; overflow: hidden; background: var(--cor-secundaria); border: 2px solid <?php echo e($proof->proof_type === 'pickup' ? '#FFD700' : '#4CAF50'); ?>;">
                                                <img src="<?php echo e($photoUrl); ?>" alt="Comprovante" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" onclick="openPhotoModal('<?php echo e($photoUrl); ?>', '<?php echo e($proof->proof_type === 'pickup' ? 'Coleta' : 'Entrega'); ?>', '<?php echo e($proof->delivery_time ? $proof->delivery_time->format('d/m/Y H:i') : 'N/A'); ?>', '<?php echo e(addslashes($proof->description ?? '')); ?>')">
                                ...
                                <?php if($proof->description): ?>
                                    <div style="background-color: rgba(255,255,255,0.05); padding: 10px; border-radius: 5px; margin-bottom: 8px;">
                                        <p style="color: rgba(245, 245, 245, 0.8); font-size: 0.85em; margin: 0;">
                                            <i class="fas fa-<?php echo e($proof->proof_type === 'pickup' ? 'hand-holding' : 'truck'); ?>"></i> 
                                            <strong><?php echo e($proof->proof_type === 'pickup' ? 'Coleta' : 'Entrega'); ?></strong> 
                                            <?php if($proof->delivery_time): ?>
                                                - <?php echo e($proof->delivery_time->format('d/m/Y H:i')); ?>
                    ...
                    <a href="<?php echo e(route('shipments.show', $shipment)); ?>" class="btn-secondary" style="padding: 8px 16px; margin-left: 15px; align-self: flex-start;">
                        Ver
                    </a>
                </div>
            </div>
...
<?php if($route->driverExpenses && $route->driverExpenses->count() > 0): ?>
<div style="background-color: var(--cor-secundaria); padding: 30px; border-radius: 15px; margin-bottom: 30px;">
    <h3 style="color: var(--cor-acento); margin-bottom: 20px;">
        <i class="fas fa-receipt"></i>
        Gastos do Motorista (<?php echo e($route->driverExpenses->count()); ?>)
    </h3>
    <div style="display: grid; gap: 15px;">
        <?php $__currentLoopData = $route->driverExpenses->sortByDesc('expense_date'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="background-color: var(--cor-principal); padding: 20px; border-radius: 10px; border-left: 4px solid <?php echo e($expense->status === 'approved' ? '#4caf50' : ($expense->status === 'rejected' ? '#f44336' : '#ffc107')); ?>;">
                <div style="display: flex; justify-content: space-between; align-items: start; flex-wrap: wrap; gap: 15px;">
                    <div style="flex: 1; min-width: 250px;">
                        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                            ...
                            <span class="status-badge <?php echo e($expense->status); ?>" style="font-size: 0.85em;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 10px; margin-top: 10px;">
                            <div>
                                ...
                                <span style="color: var(--cor-texto-claro); font-weight: 600; margin-left: 5px;">
                                    <?php echo e($expense->expense_type_label); ?>
                            ...
                            <div>
                                ...
                                <span style="color: var(--cor-texto-claro); font-weight: 600; margin-left: 5px;">
                                    <?php echo e($expense->payment_method); ?>
                        ...
                        ?>
                        <?php if(!empty($receiptImages)): ?>
                        <div style="margin-top: 15px;">
                            <p style="color: rgba(245, 245, 245, 0.7); font-size: 0.9em; margin-bottom: 8px;">
                                <i class="fas fa-image"></i> Comprovantes (<?php echo e(count($receiptImages)); ?>)
                            </p>
                            <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                                <?php $__currentLoopData = $receiptImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $imageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div style="width: 60px; height: 60px; border-radius: 6px; overflow: hidden; border: 2px solid rgba(255,255,255,0.1); cursor: pointer; transition: transform 0.2s, border-color 0.2s;" 
                                         ...
                                         onclick="openExpenseImageModalAll(<?php echo json_encode($receiptImages, 15, 512) ?>, <?php echo e($index); ?>)">
                                        <img src="<?php echo e($imageUrl); ?>" alt="Comprovante <?php echo e($index + 1); ?>" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.parentElement.style.display='none'">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    ...
                    <div style="text-align: right; display: flex; flex-direction: column; gap: 10px; align-items: flex-end;">
                        ...
                        <a href="<?php echo e(route('driver-expenses.show', $expense)); ?>" class="btn-secondary" style="padding: 8px 16px; white-space: nowrap;">
                ...
                <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid rgba(255,255,255,0.1);">
                    <p style="color: rgba(245, 245, 245, 0.8); font-size: 0.9em; margin: 0;">
                        <i class="fas fa-sticky-note"></i> <?php echo e($expense->notes); ?>
                ...
                <div style="margin-top: 15px; padding: 12px; background-color: rgba(244, 67, 54, 0.1); border-radius: 5px; border-left: 3px solid #f44336;">
                    <p style="color: #f44336; font-size: 0.9em; margin: 0;">
                        <i class="fas fa-times-circle"></i> <strong>Motivo da Rejeição:</strong> <?php echo e($expense->rejection_reason); ?>
    ...
    <div style="margin-top: 25px; padding: 20px; background: linear-gradient(135deg, rgba(33, 150, 243, 0.2) 0%, rgba(33, 150, 243, 0.1) 100%); border-radius: 10px; border-left: 4px solid #2196F3;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 15px;">
            <div>
                ...
                <p style="color: var(--cor-texto-claro); font-size: 1.3em; font-weight: 600; margin: 5px 0 0 0;">
                    R$ <?php echo e(number_format($totalExpenses, 2, ',', '.')); ?>
            ...
            <div>
                ...
                <p style="color: #4caf50; font-size: 1.3em; font-weight: 600; margin: 5px 0 0 0;">
                    R$ <?php echo e(number_format($approvedExpenses, 2, ',', '.')); ?>
            ...
            <div>
                ...
                <p style="color: #ffc107; font-size: 1.3em; font-weight: 600; margin: 5px 0 0 0;">
                    R$ <?php echo e(number_format($pendingExpenses, 2, ',', '.')); ?>
...
<script>
    ...
    window.routeId = <?php echo json_encode($routeIdValue, 15, 512) ?>;
    ...
    function displayRoute(index) {
        ...
        <?php if($route->status === 'in_progress' && $route->driver): ?>
    ...
    function updateDriverLocation() {
        ...
        const driverId = <?php echo e($route->driver->id ?? 'null'); ?>;
