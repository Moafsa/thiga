<?php $__env->startSection('title', 'New Driver - TMS SaaS'); ?>
<?php $__env->startSection('page-title', 'New Driver'); ?>
...
<div class="page-header">
    ...
    <a href="<?php echo e(route('drivers.index')); ?>" class="btn-secondary">Voltar</a>
</div>

<form action="<?php echo e(route('drivers.store')); ?>" method="POST" style="background-color: var(--cor-secundaria); padding: 30px; border-radius: 15px;">
    <?php echo csrf_field(); ?>
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 20px;">
        ...
        <div>
            ...
            <input type="text" name="document" value="<?php echo e(old('document')); ?>" placeholder="000.000.000-00" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: var(--cor-principal); color: var(--cor-texto-claro);">
        </div>
        <div>
            <label style="color: var(--cor-texto-claro); display: block; margin-bottom: 8px;">Telefone *</label>
            <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" required style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: var(--cor-principal); color: var(--cor-texto-claro);">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="email" name="email" value="<?php echo e(old('email')); ?>" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: var(--cor-principal); color: var(--cor-texto-claro);">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <input type="text" name="cnh_number" value="<?php echo e(old('cnh_number')); ?>" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: var(--cor-principal); color: var(--cor-texto-claro);">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" name="vehicle_plate" value="<?php echo e(old('vehicle_plate')); ?>" style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: var(--cor-principal); color: var(--cor-texto-claro);">
        </div>
        <div>
    ...
    <div style="display: flex; gap: 15px; justify-content: flex-end;">
        <a href="<?php echo e(route('drivers.index')); ?>" class="btn-secondary">Cancelar</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/drivers/create.blade.php ENDPATH**/ ?>