...
<?php $__env->startSection('title', 'CT-es - TMS SaaS'); ?>
<?php $__env->startSection('page-title', 'CT-es'); ?>
...
<div class="filters-card">
    <form method="GET" action="<?php echo e(route('fiscal.ctes.index')); ?>" id="filter-form">
        ...
        <table>
            ...
            <tbody id="cte-table-body">
                <?php $__empty_1 = true; $__currentLoopData = $ctes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                            <div style="font-weight: 600;"><?php echo e($cte->mitt_number ?? 'N/A'); ?></div>
                        </td>
                        <td>
                            <?php if($cte->access_key): ?>
                                <div class="access-key"><?php echo e(substr($cte->access_key, 0, 20)); ?>...</div>
                            <?php else: ?>
                                <span style="opacity: 0.5;">-</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if($cte->shipment && $cte->shipment->senderClient): ?>
                                <div><?php echo e($cte->shipment->senderClient->name); ?></div>
                                <div style="opacity: 0.7; font-size: 0.9em;"><?php echo e($cte->shipment->tracking_number); ?></div>
                            <?php else: ?>
                                <span style="opacity: 0.5;">N/A</span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <div><?php echo e($cte->created_at->format('d/m/Y')); ?></div>
                            <div style="opacity: 0.7; font-size: 0.9em;"><?php echo e($cte->created_at->format('H:i')); ?></div>
                            <?php if($cte->authorized_at): ?>
                                <div style="opacity: 0.6; font-size: 0.85em; margin-top: 3px;">
                                    Autorizado: <?php echo e($cte->authorized_at->format('d/m/Y H:i')); ?>

                                </div>
                            <?php endif; ?>
                        </td>
                        <td>
                            <span class="status-badge status-<?php echo e($cte->status); ?>">
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="<?php echo e(route('fiscal.ctes.show', $cte)); ?>" class="action-btn" title="Ver detalhes">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <?php if($cte->pdf_url): ?>
                                    <a href="<?php echo e($cte->pdf_url); ?>" target="_blank" class="action-btn" title="Ver PDF">
                                        <i class="fas fa-file-pdf"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if($cte->xml_url): ?>
                                    <a href="<?php echo e($cte->xml_url); ?>" target="_blank" class="action-btn" title="Ver XML">
...
<!-- Pagination -->
<?php if($ctes->hasPages()): ?>
    <div style="margin-top: 30px; display: flex; justify-content: center;">
        <?php echo e($ctes->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/fiscal/ctes/index.blade.php ENDPATH**/ ?>