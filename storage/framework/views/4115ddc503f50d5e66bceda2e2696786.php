...
<body>
    ...
    <nav class="bottom-nav">
        <a href="<?php echo e(route('driver.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('driver.dashboard') ? 'active' : ''); ?>">
            <i class="fas fa-home"></i>
            <span>Início</span>
        </a>
        <a href="<?php echo e(route('driver.dashboard')); ?>#routes" class="nav-item">
            <i class="fas fa-route"></i>
            <span>Rotas</span>
        </a>
        <a href="<?php echo e(route('driver.dashboard')); ?>#shipments" class="nav-item">
...
<?php /**PATH /var/www/resources/views/driver/layout.blade.php ENDPATH**/ ?>