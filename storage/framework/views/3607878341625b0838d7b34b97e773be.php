...
<?php $__env->startSection('page-title', 'Detalhes do Gasto'); ?>
...
<div class="expense-detail-card">
    <div class="expense-header">
        <div>
            <h2 class="expense-title"><?php echo e($expense->description); ?></h2>
            <span class="expense-status-badge <?php echo e($expense->status); ?>"><?php echo e($expense->status_label); ?></span>
        </div>
        <div style="display: flex; gap: 10px; align-items: center;">
            <a href="<?php echo e(route('driver-expenses.edit', $expense)); ?>" class="btn-edit">
                <i class="fas fa-edit"></i> Editar Gasto
            </a>
            <a href="<?php echo e(route('driver-expenses.index')); ?>" class="btn-back">
    ...
    <div class="detail-grid">
        <div class="detail-item">
            ...
            <div class="detail-value amount">R$ <?php echo e(number_format($expense->amount, 2, ',', '.')); ?></div>
        </div>

        <div class="detail-item">
            <div class="detail-label">Data do Gasto</div>
            <div class="detail-value"><?php echo e($expense->expense_date->format('d/m/Y')); ?></div>
        </div>

        <div class="detail-item">
            <div class="detail-label">Tipo</div>
            <div class="detail-value"><?php echo e($expense->expense_type_label); ?></div>
        </div>

        <div class="detail-item">
            <div class="detail-label">Motorista</div>
            <div class="detail-value"><?php echo e($expense->driver->name); ?></div>
        </div>
        ...
        <div class="detail-item">
            ...
            <div class="detail-value"><?php echo e($expense->payment_method); ?></div>
        </div>
        <?php endif; ?>

        <div class="detail-item">
            <div class="detail-label">Data de Registro</div>
            <div class="detail-value"><?php echo e($expense->created_at->format('d/m/Y H:i')); ?></div>
        </div>
    </div>
    ...
    <div class="detail-item" style="margin-top: 20px;">
        ...
        <div class="detail-value" style="font-weight: normal;"><?php echo e($expense->notes); ?></div>
    </div>
    <?php endif; ?>
    ...
    <div class="rejection-reason">
        ...
        <div class="rejection-reason-text"><?php echo e($expense->rejection_reason); ?></div>
    </div>
    <?php endif; ?>
    ...
    <div class="receipt-preview">
        <h4><i class="fas fa-image"></i> Comprovantes (<?php echo e(count($receiptImages)); ?>)</h4>
        <div class="receipt-images">
            <?php $__currentLoopData = $receiptImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $imageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($imageUrl && !empty(trim($imageUrl))): ?>
                <div class="receipt-image-item" style="cursor: pointer;">
                    <img src="<?php echo e($imageUrl); ?>" alt="Comprovante <?php echo e($index + 1); ?>" onclick="openImageModal('<?php echo e($imageUrl); ?>', <?php echo e($index + 1); ?>, <?php echo e(count($receiptImages)); ?>)" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" onerror="console.error('Erro ao carregar imagem:', '<?php echo e($imageUrl); ?>'); this.style.display='none'; this.parentElement.innerHTML='<div style=\\'padding: 20px; text-align: center; color: rgba(245,245,245,0.5);\\'><i class=\\'fas fa-image\\'></i><br>Imagem não encontrada</div>';">
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/admin/driver-expenses/show.blade.php ENDPATH**/ ?>