...
<?php $__env->startSection('title', 'New Company - TMS SaaS'); ?>
<?php $__env->startSection('page-title', 'New Company'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="trade_name" id="trade_name" value="<?php echo e(old('trade_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="ie" id="ie" value="<?php echo e(old('ie')); ?>">
                <?php $__errorArgs = ['ie'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="im" id="im" value="<?php echo e(old('im')); ?>">
                <?php $__errorArgs = ['im'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="address_number" id="address_number" value="<?php echo e(old('address_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="complement" id="complement" value="<?php echo e(old('complement')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="neighborhood" id="neighborhood" value="<?php echo e(old('neighborhood')); ?>" required>
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <select name="crt" id="crt" required>
                    ...
                    <option value="1" <?php echo e(old('crt') == '1' ? 'selected' : ''); ?>>1 - Simples Nacional</option>
                    <option value="2" <?php echo e(old('crt') == '2' ? 'selected' : ''); ?>>2 - Simples Nacional - Excesso de sublimite de receita bruta</option>
                    <option value="3" <?php echo e(old('crt') == '3' ? 'selected' : ''); ?>>3 - Regime Normal</option>
                </select>
                <?php $__errorArgs = ['crt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="cnae" id="cnae" value="<?php echo e(old('cnae')); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/companies/create.blade.php ENDPATH**/ ?>