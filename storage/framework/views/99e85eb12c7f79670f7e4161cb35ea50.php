...
<body>
    <div class="page-wrapper">
        <div class="login-container">
            <a class="back-link" href="<?php echo e(route('driver.login.phone')); ?>">
            ...
            <?php if(isset($tenantName)): ?>
                <div class="message-card success">
                    Acessando empresa: <?php echo e($tenantName); ?>
            ...
            <?php if(session('code_sent')): ?>
                <div class="message-card success">
                    Já enviamos um código para <?php echo e(session('phone', $phone)); ?>.
                </div>
            <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('driver.login.verify-code')); ?>">
                <?php echo csrf_field(); ?>
            ...
            <div class="links">
                <p>Não recebeu? <a href="<?php echo e(route('driver.login.phone')); ?>">Peça outro código</a></p>
            </div>
        </div>
    </div>
</body>
...
<?php /**PATH /var/www/resources/views/auth/driver-login-code.blade.php ENDPATH**/ ?>