        ...
        <div class="links">
            ...
            <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255, 255, 255, 0.1);">
                ...
                <p style="margin-top: 10px;">
                    <a href="<?php echo e(route('client.login.phone')); ?>" style="display: inline-flex; align-items: center; gap: 8px;">
                        <i class="fas fa-user"></i> Sou cliente - Entrar por telefone
                    </a>
                </p>
                
                <p style="margin-top: 10px;">
                    <a href="<?php echo e(route('salesperson.login.phone')); ?>" style="display: inline-flex; align-items: center; gap: 8px;">
