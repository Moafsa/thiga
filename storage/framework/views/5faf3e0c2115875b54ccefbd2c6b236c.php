...
<body class="bg-gray-50">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                <a href="<?php echo e(route('freight-tables.show', $freightTable)); ?>" class="text-gray-500 hover:text-gray-700 mr-4">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Editar Tabela de Frete</h1>
                    <p class="text-gray-600 mt-2"><?php echo e($freightTable->name); ?></p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form method="POST" action="<?php echo e(route('freight-tables.update', $freightTable)); ?>" class="space-y-8">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="<?php echo e(old('name', $freightTable->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="destination_name" name="destination_name" value="<?php echo e(old('destination_name', $freightTable->destination_name)); ?>" required
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="destination_state" name="destination_state" value="<?php echo e(old('destination_state', $freightTable->destination_state)); ?>" maxlength="2"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"><?php echo e(old('description', $freightTable->description)); ?></textarea>
                    </div>

                    <!-- CEP Range -->
                    <div id="cep_range_fields" class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 <?php echo e($freightTable->destination_type === 'cep_range' ? '' : 'hidden'); ?>">
                        <div>
                            <label for="cep_range_start" class="block text-sm font-medium text-gray-700 mb-2">CEP Inicial</label>
                            <input type="text" id="cep_range_start" name="cep_range_start" value="<?php echo e(old('cep_range_start', $freightTable->cep_range_start)); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        </div>
                        <div>
                            <label for="cep_range_end" class="block text-sm font-medium text-gray-700 mb-2">CEP Final</label>
                            <input type="text" id="cep_range_end" name="cep_range_end" value="<?php echo e(old('cep_range_end', $freightTable->cep_range_end)); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        </div>
                    </div>

                    <div class="md:col-span-2 flex items-center">
                        <input type="checkbox" id="is_default" name="is_default" value="1" <?php echo e(old('is_default', $freightTable->is_default) ? 'checked' : ''); ?>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" id="weight_0_30" name="weight_0_30" value="<?php echo e(old('weight_0_30', $freightTable->weight_0_30)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="weight_31_50" class="block text-sm font-medium text-gray-700 mb-2">31 a 50 kg (R$)</label>
                        <input type="number" id="weight_31_50" name="weight_31_50" value="<?php echo e(old('weight_31_50', $freightTable->weight_31_50)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="weight_51_70" class="block text-sm font-medium text-gray-700 mb-2">51 a 70 kg (R$)</label>
                        <input type="number" id="weight_51_70" name="weight_51_70" value="<?php echo e(old('weight_51_70', $freightTable->weight_51_70)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="weight_71_100" class="block text-sm font-medium text-gray-700 mb-2">71 a 100 kg (R$)</label>
                        <input type="number" id="weight_71_100" name="weight_71_100" value="<?php echo e(old('weight_71_100', $freightTable->weight_71_100)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="weight_over_100_rate" class="block text-sm font-medium text-gray-700 mb-2">Taxa por kg acima de 100kg (R$/kg)</label>
                        <input type="number" id="weight_over_100_rate" name="weight_over_100_rate" value="<?php echo e(old('weight_over_100_rate', $freightTable->weight_over_100_rate)); ?>" step="0.0001" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="ctrc_tax" class="block text-sm font-medium text-gray-700 mb-2">Taxa CTRC acima de 100kg (R$)</label>
                        <input type="number" id="ctrc_tax" name="ctrc_tax" value="<?php echo e(old('ctrc_tax', $freightTable->ctrc_tax)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" id="ad_valorem_rate" name="ad_valorem_rate" value="<?php echo e(old('ad_valorem_rate', $freightTable->ad_valorem_rate * 100)); ?>" step="0.0001" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="number" id="gris_rate" name="gris_rate" value="<?php echo e(old('gris_rate', $freightTable->gris_rate * 100)); ?>" step="0.0001" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    ...
                    <div>
                        ...
                        <input type="number" id="gris_minimum" name="gris_minimum" value="<?php echo e(old('gris_minimum', $freightTable->gris_minimum)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="toll_per_100kg" class="block text-sm font-medium text-gray-700 mb-2">Pedágio por 100kg (R$)</label>
                        <input type="number" id="toll_per_100kg" name="toll_per_100kg" value="<?php echo e(old('toll_per_100kg', $freightTable->toll_per_100kg)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="cubage_factor" class="block text-sm font-medium text-gray-700 mb-2">Fator de Cubagem (kg/m³)</label>
                        <input type="number" id="cubage_factor" name="cubage_factor" value="<?php echo e(old('cubage_factor', $freightTable->cubage_factor)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="min_freight_rate_vs_nf" class="block text-sm font-medium text-gray-700 mb-2">Frete Mínimo vs NF (%)</label>
                        <input type="number" id="min_freight_rate_vs_nf" name="min_freight_rate_vs_nf" value="<?php echo e(old('min_freight_rate_vs_nf', $freightTable->min_freight_rate_vs_nf * 100)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" id="tde_markets" name="tde_markets" value="<?php echo e(old('tde_markets', $freightTable->tde_markets)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="tde_supermarkets_cd" class="block text-sm font-medium text-gray-700 mb-2">TDE CD Supermercados (R$)</label>
                        <input type="number" id="tde_supermarkets_cd" name="tde_supermarkets_cd" value="<?php echo e(old('tde_supermarkets_cd', $freightTable->tde_supermarkets_cd)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="palletization" class="block text-sm font-medium text-gray-700 mb-2">Paletização por Pallet (R$)</label>
                        <input type="number" id="palletization" name="palletization" value="<?php echo e(old('palletization', $freightTable->palletization)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="unloading_tax" class="block text-sm font-medium text-gray-700 mb-2">Taxa de Descarga (R$)</label>
                        <input type="number" id="unloading_tax" name="unloading_tax" value="<?php echo e(old('unloading_tax', $freightTable->unloading_tax)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" id="weekend_holiday_rate" name="weekend_holiday_rate" value="<?php echo e(old('weekend_holiday_rate', $freightTable->weekend_holiday_rate * 100)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="redelivery_rate" class="block text-sm font-medium text-gray-700 mb-2">Reentrega (%)</label>
                        <input type="number" id="redelivery_rate" name="redelivery_rate" value="<?php echo e(old('redelivery_rate', $freightTable->redelivery_rate * 100)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
                        <label for="return_rate" class="block text-sm font-medium text-gray-700 mb-2">Devolução (%)</label>
                        <input type="number" id="return_rate" name="return_rate" value="<?php echo e(old('return_rate', $freightTable->return_rate * 100)); ?>" step="0.01" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-4">
                <a href="<?php echo e(route('freight-tables.show', $freightTable)); ?>" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                    Cancelar
                </a>
...
<?php /**PATH /var/www/resources/views/freight-tables/edit.blade.php ENDPATH**/ ?>