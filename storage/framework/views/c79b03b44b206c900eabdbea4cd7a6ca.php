...
<head>
    ...
    <style>
        ...
        :root {
            --cor-principal:
                <?php echo e(Auth::check() && Auth::user()->tenant ? (Auth::user()->tenant->primary_color ?? '#245a49') : '#245a49'); ?>

            ;
            --cor-secundaria:
                <?php echo e(Auth::check() && Auth::user()->tenant ? (Auth::user()->tenant->secondary_color ?? '#1a3d33') : '#1a3d33'); ?>

            ;
            --cor-acento:
                <?php echo e(Auth::check() && Auth::user()->tenant ? (Auth::user()->tenant->accent_color ?? '#FF6B35') : '#FF6B35'); ?>
...
<body x-data="{ sidebarOpen: false }">
    ...
    <aside class="sidebar" :class="{ 'expanded': sidebarOpen }">
        ...
        <nav class="sidebar-nav">
            <div class="sidebar-item">
                <a href="<?php echo e(route('dashboard')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" title="Painel">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('monitoring.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('monitoring.*') ? 'active' : ''); ?>" title="Monitoramento">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('routes.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('routes.*') ? 'active' : ''); ?>" title="Rotas">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('shipments.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('shipments.*') ? 'active' : ''); ?>" title="Cargas">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('drivers.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('drivers.*') ? 'active' : ''); ?>" title="Motoristas">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('vehicles.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('vehicles.*') ? 'active' : ''); ?>" title="Veículos">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('cte-xmls.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('cte-xmls.*') ? 'active' : ''); ?>" title="CT-e XMLs">
                    <i class="fas fa-file-code"></i> <span>Upload de XML</span>
                </a>
            </div>

            <div class="sidebar-item">
                <a href="<?php echo e(route('fiscal.ctes.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('fiscal.ctes.*') ? 'active' : ''); ?>" title="CT-es">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('crm.board')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('crm.*') ? 'active' : ''); ?>" title="CRM & Pipeline">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('clients.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('clients.*') ? 'active' : ''); ?>" title="Clientes">
                    <i class="fas fa-user-friends"></i> <span>Clientes</span>
                </a>
            </div>
            
            <div class="sidebar-item">
                <a href="<?php echo e(route('salespeople.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('salespeople.*') ? 'active' : ''); ?>" title="Vendedores">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('proposals.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('proposals.index') ? 'active' : ''); ?>" title="Propostas">
                    <i class="fas fa-file-contract"></i> <span>Propostas</span>
                </a>
            </div>

            <div class="sidebar-item">
                <a href="<?php echo e(route('proposals.quick')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('proposals.quick') ? 'active' : ''); ?>"
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('freight-tables.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('freight-tables.*') ? 'active' : ''); ?>"
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('invoicing.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('invoicing.*') ? 'active' : ''); ?>" title="Faturamento">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('financial.accounts-receivable')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('financial.accounts-receivable') ? 'active' : ''); ?>"
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('financial.accounts-payable')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('financial.accounts-payable') ? 'active' : ''); ?>"
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('cash-flow.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('cash-flow.*') ? 'active' : ''); ?>" title="Fluxo de Caixa">
                    <i class="fas fa-chart-area"></i> <span>Fluxo de Caixa</span>
                </a>
            </div>

            <div class="sidebar-item">
                <a href="<?php echo e(route('financial.reconciliation')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('financial.reconciliation') ? 'active' : ''); ?>"
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('financial.reports.dre')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('financial.reports.dre') ? 'active' : ''); ?>"
                    title="DRE (Relatório)">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('companies.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('companies.*') ? 'active' : ''); ?>" title="Empresas">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('subscriptions.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('subscriptions.*') ? 'active' : ''); ?>"
                    title="Assinaturas">
            ...
            <div class="sidebar-item">
                <a href="<?php echo e(route('settings.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('settings.*') ? 'active' : ''); ?>" title="Configurações">
        ...
        <div class="sidebar-footer">
            <form method="POST" action="<?php echo e(route('logout')); ?>" style="display: flex; flex-direction: column; width: 100%;">
                <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('js/route-map-mapbox.js')); ?>"></script>
    <script src="<?php echo e(asset('js/monitoring-mapbox.js')); ?>"></script>
    ...
    (function() {
        ...
        async function fetchResults(q) {
            try {
                const res  = await fetch(`<?php echo e(route('search')); ?>?q=${encodeURIComponent(q)}`, {
        ...
        function renderResults(items, q) {
            ...
            html += `<a href="<?php echo e(route('search')); ?>?q=${encodeURIComponent(input.value)}" style="display: block; padding: 12px 16px; text-align: center; color: var(--cor-acento); font-size: 0.85em; text-decoration: none; border-top: 1px solid rgba(255,107,53,0.15);">
