...
<body>
    <div class="page">
        <div class="login-container">
            ...
            <form method="POST" action="<?php echo e(route('driver.login.request-code')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="<?php echo e(old('phone', session('driver_login_phone'))); ?>"
                        required
                        autofocus
                        pattern="[0-9]{10,11}"
                    >
            ...
            <div class="links">
                <p>Já recebeu o código? <a href="<?php echo e(route('driver.login.code')); ?>">Confirme aqui</a></p>
            </div>
        </div>
    </div>
</body>
