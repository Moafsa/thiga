...
<body>
    <div class="page">
        <div class="login-container">
            ...
            <?php if(isset($tenantOptionsData) && count($tenantOptionsData)): ?>
                <div class="form-group">
                    <label for="tenant_id">Empresa</label>
                    <select name="tenant_id" id="tenant_id" required>
                        <option value="">Selecione a empresa</option>
                        <?php $__currentLoopData = $tenantOptionsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($option['tenant_id']); ?>" <?php echo e(old('tenant_id') == $option['tenant_id'] ? 'selected' : ''); ?>>
                                <?php echo e($option['tenant_name']); ?>

                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php if($errors->has('tenant_id')): ?>
                        <small style="color: #ff7a4a; margin-top: 4px; display: block;">
                            <?php echo e($errors->first('tenant_id')); ?>
            ...
            <form method="POST" action="<?php echo e(route('client.login.request-code')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="<?php echo e(old('phone', session('client_login_phone'))); ?>"
                        required
                        autofocus
                        pattern="[0-9]{10,11}"
                    >
            ...
            <div class="links">
                <p>Já recebeu o código? <a href="<?php echo e(route('client.login.code')); ?>">Confirme aqui</a></p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/resources/views/auth/client-login-phone.blade.php ENDPATH**/ ?>