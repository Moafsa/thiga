...
<head>
    ...
    <title>Fatura #<?php echo e($invoice->invoice_number); ?> - Contas a Receber</title>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex justify-between items-start mb-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">Fatura #<?php echo e($invoice->invoice_number); ?></h1>
                    <p class="text-gray-600">Cliente: <span class="font-semibold"><?php echo e($invoice->client->name); ?></span></p>
                </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                <div>
                    ...
                    <p class="font-semibold text-gray-900"><?php echo e($invoice->issue_date->format('d/m/Y')); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Data de Vencimento</p>
                    <p class="font-semibold text-gray-900"><?php echo e($invoice->due_date->format('d/m/Y')); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Valor Total</p>
                    <p class="font-semibold text-gray-900">R$ <?php echo e(number_format($invoice->total_amount, 2, ',', '.')); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600">Saldo Restante</p>
                    <p class="font-semibold <?php echo e($invoice->remaining_balance > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                        ...
                        <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm font-semibold text-gray-900 text-right">
                                    R$ <?php echo e(number_format($item->total_price, 2, ',', '.')); ?>
    ...
    <div id="paymentModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50 flex items-center justify-center">
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div class="p-6">
                ...
                <form method="POST" action="<?php echo e(route('accounts.receivable.payment', $invoice)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Valor * (Máximo: R$ <?php echo e(number_format($invoice->remaining_balance, 2, ',', '.')); ?>)
                            </label>
                            <input type="number" 
                                   name="amount" 
                                   step="0.01" 
                                   min="0.01" 
                                   max="<?php echo e($invoice->remaining_balance); ?>" 
                                   value="<?php echo e($invoice->remaining_balance); ?>"
                                   required
...
<?php /**PATH /var/www/resources/views/accounts/receivable/show.blade.php ENDPATH**/ ?>