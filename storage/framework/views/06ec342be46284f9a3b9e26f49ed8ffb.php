...
<div class="page-header">
    ...
    <a href="<?php echo e(route('shipments.create')); ?>" class="btn-primary">
        ...
        <div class="filters-grid">
            <div class="filter-group">
                ...
                <select name="status">
                    ...
                    <option value="scheduled" <?php echo e(request('status') === 'scheduled' ? 'selected' : ''); ?>>Agendada</option>
                    <option value="picked_up" <?php echo e(request('status') === 'picked_up' ? 'selected' : ''); ?>>Coletada</option>
                    <option value="in_transit" <?php echo e(request('status') === 'in_transit' ? 'selected' : ''); ?>>Em Trânsito</option>
                    <option value="delivered" <?php echo e(request('status') === 'delivered' ? 'selected' : ''); ?>>Entregue</option>
                    <option value="returned" <?php echo e(request('status') === 'returned' ? 'selected' : ''); ?>>Devolvida</option>
...
<div id="bulk-actions" style="display: none; background-color: var(--cor-secundaria); padding: 15px 25px; border-radius: 15px; margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center;">
    ...
    <div style="display: flex; gap: 10px;">
        ...
        <form id="bulk-delete-form" action="<?php echo e(route('shipments.bulk-destroy')); ?>" method="POST" style="display: inline;" onsubmit="return submitBulkDelete(event);">
            <?php echo csrf_field(); ?>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $shipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        <td>
                            <?php if($canDelete): ?>
                                <input type="checkbox" class="shipment-checkbox" value="<?php echo e($shipment->id); ?>" onchange="updateBulkActions()">
                            <?php endif; ?>
                        </td>
                        <td>
                            <div style="font-weight: 600;"><?php echo e($shipment->tracking_number); ?></div>
                        </td>
                        <td>
                            <div style="font-weight: 600;"><?php echo e($shipment->title); ?></div>
                            <?php if($shipment->description): ?>
                                <div style="opacity: 0.7; font-size: 0.9em;"><?php echo e(Str::limit($shipment->description, 50)); ?></div>
                            <?php endif; ?>
                        </td>
                        <td>
                            <div><?php echo e($shipment->senderClient->name ?? 'N/A'); ?></div>
                            <div style="opacity: 0.7; font-size: 0.9em;"><?php echo e($shipment->pickup_city); ?>/<?php echo e($shipment->pickup_state); ?></div>
                        </td>
                        <td>
                            <div><?php echo e($shipment->receiverClient->name ?? 'N/A'); ?></div>
                            <div style="opacity: 0.7; font-size: 0.9em;"><?php echo e($shipment->delivery_city); ?>/<?php echo e($shipment->delivery_state); ?></div>
                        </td>
                        <td>
                            <div><?php echo e($shipment->pickup_date->format('d/m/Y')); ?></div>
                            <div style="opacity: 0.7; font-size: 0.9em;"><?php echo e($shipment->pickup_time); ?></div>
                        </td>
                        <td>
                            <?php
                                $statusLabels = [
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="<?php echo e(route('shipments.show', $shipment)); ?>" class="action-btn" title="Ver detalhes">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('shipments.edit', $shipment)); ?>" class="action-btn" title="Editar">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/shipments/index.blade.php ENDPATH**/ ?>