...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="origin_name" id="origin_name" value="<?php echo e(old('origin_name', 'São Paulo')); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="origin_state" id="origin_state" value="<?php echo e(old('origin_state', 'SP')); ?>" 
            ...
            <div class="form-group">
                <label>
                    <input type="checkbox" name="visible_to_clients" value="1" <?php echo e(old('visible_to_clients') ? 'checked' : ''); ?>>
    ...
    <div class="form-section">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="number" name="tda_rate" id="tda_rate" value="<?php echo e(old('tda_rate', 0)); ?>" 
    ...
    <div class="form-section">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="number" name="min_freight_rate_value" id="min_freight_rate_value" value="<?php echo e(old('min_freight_rate_value')); ?>" 
