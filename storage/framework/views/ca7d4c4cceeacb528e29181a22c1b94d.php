...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="payment_method" 
                                ...
                                <option value="Transferência Bancária" <?php echo e(old('payment_method') === 'Transferência Bancária' ? 'selected' : ''); ?>>Transferência Bancária</option>
                                ...
                                <option value="Cartão de Débito" <?php echo e(old('payment_method') === 'Cartão de Débito' ? 'selected' : ''); ?>>Cartão de Débito</option>
                    ...
                    <div>
                        ...
                        <textarea name="notes" 
                                  rows="4" 
                                  class="w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"><?php echo e(old('notes')); ?></textarea>
...
<?php /**PATH /var/www/resources/views/accounts/payable/create.blade.php ENDPATH**/ ?>