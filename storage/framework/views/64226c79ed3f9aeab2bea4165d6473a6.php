...
<head>
    ...
    <title>Login Vendedor - TMS SaaS</title>
...
<body>
    <div class="page">
        <div class="login-container">
            ...
            <div class="logo">
                <i class="fas fa-briefcase"></i> TMS SaaS
            </div>
            ...
            <form method="POST" action="<?php echo e(route('salesperson.login.request-code')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="<?php echo e(old('phone', session('salesperson_login_phone'))); ?>"
                        required
                        autofocus
                        pattern="[0-9]{10,11}"
                    >
            ...
            <div class="links">
                <p>Já recebeu o código? <a href="<?php echo e(route('salesperson.login.code')); ?>">Confirme aqui</a></p>
            </div>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/resources/views/auth/salesperson-login-phone.blade.php ENDPATH**/ ?>