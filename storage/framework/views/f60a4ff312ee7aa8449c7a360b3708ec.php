<?php $__env->startSection('title', 'Nova Proposta Comercial - TMS SaaS'); ?>
<?php $__env->startSection('page-title', 'Nova Proposta Comercial'); ?>
...
<div class="proposal-container" id="proposal-content">
    ...
    <main class="proposal-content">
        ...
        <section class="calculator-section">
            ...
            <form id="freight-calculator-form" action="<?php echo e(route('proposals.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-grid">
                        ...
                        <select name="client_id" id="client_id" required>
                            ...
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($client->id); ?>" 
                                        <?php echo e(($selectedClient && $selectedClient->id == $client->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="valid_until" name="valid_until" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
                    </div>
                </div>
                ...
                <div class="form-grid" style="margin-top: 20px;">
                    <div class="form-group full-width">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>" required placeholder="Ex: Proposta de Frete - Belo Horizonte">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea name="description" id="description" rows="3" placeholder="Descrição da proposta..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Opções de Envio -->
                <?php if($hasEmailConfigured || $hasWhatsAppConnected): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/proposals/create.blade.php ENDPATH**/ ?>