...
<?php $__env->startSection('page-title', 'Editar Gasto'); ?>
...
<div class="expense-edit-card">
    <div class="expense-header">
        <div>
            ...
            <span class="expense-status-badge <?php echo e($expense->status); ?>" style="display: inline-block; padding: 8px 16px; border-radius: 20px; font-size: 0.9em; font-weight: 600; background: <?php echo e($expense->status === 'approved' ? 'rgba(76, 175, 80, 0.2)' : ($expense->status === 'rejected' ? 'rgba(244, 67, 54, 0.2)' : 'rgba(255, 193, 7, 0.2)')); ?>; color: <?php echo e($expense->status === 'approved' ? '#4caf50' : ($expense->status === 'rejected' ? '#f44336' : '#ffc107')); ?>;">
                <?php echo e($expense->status_label); ?>

            </span>
        </div>
        <a href="<?php echo e(route('driver-expenses.show', $expense)); ?>" class="btn-cancel">
            <i class="fas fa-arrow-left"></i> Cancelar
        </a>
    </div>

    <form method="POST" action="<?php echo e(route('driver-expenses.update', $expense)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <select name="expense_type" class="form-select" required>
                    <option value="toll" <?php echo e(old('expense_type', $expense->expense_type) === 'toll' ? 'selected' : ''); ?>>Pedágio</option>
                    <option value="fuel" <?php echo e(old('expense_type', $expense->expense_type) === 'fuel' ? 'selected' : ''); ?>>Combustível</option>
                    <option value="meal" <?php echo e(old('expense_type', $expense->expense_type) === 'meal' ? 'selected' : ''); ?>>Refeição</option>
                    <option value="parking" <?php echo e(old('expense_type', $expense->expense_type) === 'parking' ? 'selected' : ''); ?>>Estacionamento</option>
                    <option value="other" <?php echo e(old('expense_type', $expense->expense_type) === 'other' ? 'selected' : ''); ?>>Outro</option>
                </select>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <p style="color: #f44336; font-size: 0.85em; margin-top: 5px;"><?php echo e($message); ?></p>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" name="amount" step="0.01" min="0.01" value="<?php echo e(old('amount', $expense->amount)); ?>" class="form-input" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="date" name="expense_date" value="<?php echo e(old('expense_date', $expense->expense_date->format('Y-m-d'))); ?>" class="form-input" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group" style="grid-column: 1 / -1;">
                ...
                <input type="text" name="description" value="<?php echo e(old('description', $expense->description)); ?>" class="form-input" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group" style="grid-column: 1 / -1;">
                ...
                <textarea name="notes" rows="4" class="form-textarea"><?php echo e(old('notes', $expense->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="receipt-preview">
                        ...
                        <?php $__currentLoopData = $receiptImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $imageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($imageUrl): ?>
                            <img src="<?php echo e($imageUrl); ?>" alt="Comprovante atual" onclick="openImageModal('<?php echo e($imageUrl); ?>', <?php echo e($index + 1); ?>, <?php echo e(count($receiptImages)); ?>)" style="margin-right: 10px; margin-bottom: 10px;">
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/admin/driver-expenses/edit.blade.php ENDPATH**/ ?>