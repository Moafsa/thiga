...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            <form method="POST" action="<?php echo e(route('salespeople.store')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="document" name="document" value="<?php echo e(old('document')); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <div class="border-b pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="commission_rate" name="commission_rate" value="<?php echo e(old('commission_rate')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="max_discount_percentage" name="max_discount_percentage" value="<?php echo e(old('max_discount_percentage')); ?>" 
                                   min="0" max="100" step="0.01" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="<?php echo e(route('salespeople.index')); ?>" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                        Cancelar
                    </a>
...
<?php /**PATH /var/www/resources/views/salespeople/create.blade.php ENDPATH**/ ?>