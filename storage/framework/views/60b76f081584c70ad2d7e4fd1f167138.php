...
<body>
    ...
    <div class="register-container">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="company_name" name="company_name" value="<?php echo e(old('company_name')); ?>" required placeholder="Example Logistics Ltd.">
                </div>
                <div class="form-group">
                    <label for="company_cnpj">CNPJ</label>
                    <input type="text" id="company_cnpj" name="company_cnpj" value="<?php echo e(old('company_cnpj')); ?>" required placeholder="00.000.000/0000-00">
                </div>
                <div class="form-group">
                    <label for="company_domain">Custom domain (optional)</label>
                    <input type="text" id="company_domain" name="company_domain" value="<?php echo e(old('company_domain')); ?>" placeholder="logistics.example.com">
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required autofocus placeholder="Your full name">
                </div>
                <div class="form-group">
                    <label for="email">Email address</label>
                    <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="you@company.com">
                </div>
                <div class="form-group">
                    <label for="phone">Phone (optional)</label>
                    <input type="text" id="phone" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="+55 11 90000-0000">
                </div>
                <div class="form-grid">
                    <div class="form-group">
        ...
        <div class="links">
            <p>Already registered? <a href="<?php echo e(route('login')); ?>">Sign in</a></p>
        </div>
    </div>
</body>
</html>
