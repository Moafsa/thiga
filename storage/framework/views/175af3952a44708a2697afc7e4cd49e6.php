...
} elseif ($_instance->childHasBeenRendered('EHPFfSn')) {
    $componentId = $_instance->getRenderedChildComponentId('EHPFfSn');
    $componentTag = $_instance->getRenderedChildComponentTagName('EHPFfSn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EHPFfSn');
} else {
    $response = \Livewire\Livewire::mount('invoicing-tool');
    $html = $response->html();
    $_instance->logRenderedChild('EHPFfSn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
