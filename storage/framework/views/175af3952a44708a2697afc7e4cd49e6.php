<?php $__env->startSection('title', 'Faturamento - Thiga TMS'); ?>
...
<div class="inv-stat-grid">
    <div class="inv-stat-card">
        ...
        <div>
            ...
            <div class="inv-stat-value"><?php echo e($stats['uninvoiced_count']); ?></div>
        </div>
    </div>
    <div class="inv-stat-card">
        ...
        <div>
            ...
            <div class="inv-stat-value">R$ <?php echo e(number_format($stats['uninvoiced_value'], 2, ',', '.')); ?></div>
        </div>
    </div>
    <div class="inv-stat-card">
        ...
        <div>
            ...
            <div class="inv-stat-value"><?php echo e($stats['total_open_invoices']); ?></div>
        </div>
    </div>
    <div class="inv-stat-card">
        ...
        <div>
            ...
            <div class="inv-stat-value">R$ <?php echo e(number_format($stats['total_open_value'], 2, ',', '.')); ?></div>
        </div>
    </div>
</div>
...
<div class="inv-section" style="padding: 20px 28px;">
    <form method="GET" action="<?php echo e(route('invoicing.index')); ?>" style="display: flex; gap: 14px; flex-wrap: wrap; align-items: flex-end;">
        <div>
        ...
        <a href="<?php echo e(route('invoicing.index')); ?>" class="btn-secondary" style="padding: 10px 20px;">
...
<div class="inv-section">
    <h2>
        ...
        <span style="font-size: 0.75em; color: rgba(245,245,245,0.5); font-weight: 400; margin-left: 8px;">(<?php echo e($uninvoicedShipments->count()); ?> cargas)</span>
    </h2>

    <?php if($uninvoicedShipments->isEmpty()): ?>
    ...
    <?php else: ?>
        <form id="invoicing-form" method="POST" action="<?php echo e(route('invoicing.generate')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div style="overflow-x: auto;">
                <table class="inv-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $uninvoicedShipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="checkbox-col">
                                <input type="checkbox" name="shipment_ids[]" value="<?php echo e($s->id); ?>"
                                    class="shipment-checkbox"
                                    style="width: 16px; height: 16px; accent-color: var(--cor-acento);">
                            </td>
                            <td>
                                <a href="<?php echo e(route('shipments.show', $s)); ?>"
                            ...
                            <td><?php echo e($s->senderClient->name ?? '—'); ?></td>
                            <td><?php echo e($s->delivered_at ? $s->delivered_at->format('d/m/Y') : '—'); ?></td>
                            <td>
                                <strong style="color: #4caf50;">
                                    R$ <?php echo e(number_format($s->freight_value ?? $s->value ?? 0, 2, ',', '.')); ?>
...
<!-- Recent Invoices -->
<?php if($recentInvoices->isNotEmpty()): ?>
<div class="inv-section">
    <h2>
    ...
    <table class="inv-table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <strong style="color: var(--cor-acento);"><?php echo e($inv->invoice_number); ?></strong>
                </td>
                <td><?php echo e($inv->client->name ?? '—'); ?></td>
                <td><?php echo e($inv->issue_date->format('d/m/Y')); ?></td>
                <td><?php echo e($inv->due_date->format('d/m/Y')); ?></td>
                <td><strong>R$ <?php echo e(number_format($inv->total_amount, 2, ',', '.')); ?></strong></td>
                <td>
                    <?php
                    ...
                    ?>
                    <span class="status-badge" style="background: rgba(0,0,0,0.2); color: <?php echo e($colors[$inv->status] ?? '#ffc107'); ?>;">
                        <?php echo e($labels[$inv->status] ?? $inv->status); ?>

                    </span>
                </td>
                <td>
                    <a href="<?php echo e(route('invoices.show', $inv)); ?>" class="btn-secondary" style="padding: 6px 14px; font-size: 0.85em;">
...
<script>
    ...
    const shipValues = {
        <?php $__currentLoopData = $uninvoicedShipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo e($s->id); ?>: <?php echo e($s->freight_value ?? $s->value ?? 0); ?>,
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    };
