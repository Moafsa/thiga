...
} elseif ($_instance->childHasBeenRendered('B85fvEC')) {
    $componentId = $_instance->getRenderedChildComponentId('B85fvEC');
    $componentTag = $_instance->getRenderedChildComponentTagName('B85fvEC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('B85fvEC');
} else {
    $response = \Livewire\Livewire::mount('invoicing-tool');
    $html = $response->html();
    $_instance->logRenderedChild('B85fvEC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
