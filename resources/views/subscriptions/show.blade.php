...
<head>
    ...
    <title>{{ $plan->name }} - TMS SaaS</title>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="billing_cycle" name="billing_cycle" required>
                                <option value="monthly">Mensal - R$ {{ number_format($plan->price, 2, ',', '.') }}</option>
                                <option value="yearly">Anual - R$ {{ number_format($plan->price * 12 * 0.9, 2, ',', '.') }} (10% desconto)</option>
                            </select>
                        </div>
