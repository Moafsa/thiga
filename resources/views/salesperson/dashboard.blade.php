        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-gray-700">{{ $salesperson->name }}</span>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['total_proposals'] }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-yellow-600 mt-2">{{ $stats['pending_proposals'] }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 mt-2">{{ $stats['accepted_proposals'] }}</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <select id="destination" name="destination" required
                            ...
                            @foreach($destinations as $dest)
                                <option value="{{ $dest->destination_name }}">{{ $dest->destination_name }} @if($dest->destination_state)({{ $dest->destination_state }})@endif</option>
                            @endforeach
                        </select>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('proposals.create') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm">
                ...
                <div class="space-y-4">
                    @forelse($recentProposals as $proposal)
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <h3 class="font-semibold text-gray-900">{{ $proposal->client->name ?? 'Cliente não informado' }}</h3>
                                ...
                                <div>
                                    <span class="px-3 py-1 text-xs font-semibold rounded-full
                                        ...
                                        @elseif($proposal->status === 'negotiating') bg-yellow-100 text-yellow-800
                            ...
                            <div class="mt-3">
                                <a href="{{ route('proposals.show', $proposal) }}" class="text-green-600 hover:text-green-800 text-sm font-medium">
                    ...
                    @empty
                        <div class="text-center py-8">
                            ...
                            <a href="{{ route('proposals.create') }}" class="mt-4 inline-block bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition-colors">
                                <i class="fas fa-plus mr-2"></i>
                ...
                @if($recentProposals->count() > 0)
                    <div class="mt-6 text-center">
                        <a href="{{ route('proposals.index') }}" class="text-green-600 hover:text-green-800 font-medium">
