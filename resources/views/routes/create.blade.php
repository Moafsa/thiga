    ...
    <form action="{{ route('routes.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div
            ...
            <div>
                ...
                <select name="driver_id" id="driver_id"
                    ...
                    @foreach($drivers as $driver)
                        <option value="{{ $driver->id }}" data-vehicles="{{ $driver->vehicles->pluck('id')->toJson() }}">
                            {{ $driver->name }}</option>
                    @endforeach
                </select>
            </div>
            <div>
                ...
                <small style="color: rgba(245, 245, 245, 0.6);">Apenas veículos atribuídos ao motorista selecionado serão
                    exibidos</small>
            </div>
            <div>
        ...
        <div style="margin-bottom: 20px; background-color: var(--cor-principal); padding: 20px; border-radius: 10px;">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <small style="color: rgba(245, 245, 245, 0.6); display: block; margin-left: 30px; margin-bottom: 15px;">Será
                ...
                <div id="manual_address"
                    ...
                    <div>
                        <label
                            ...
                            *</label>
                        <input type="text" name="start_address" value="{{ old('start_address') }}" placeholder="Rua, número"
                    ...
                    <div>
                        ...
                        <input type="text" name="start_zip_code" value="{{ old('start_zip_code') }}" placeholder="00000-000"
                            style="width: 100%; padding: 10px; border-radius: 5px; border: 1px solid rgba(255,255,255,0.2); background: var(--cor-secundaria); color: var(--cor-texto-claro);">
                    </div>
                </div>
            </div>
        ...
        <div style="margin-bottom: 20px; background-color: var(--cor-principal); padding: 20px; border-radius: 10px;">
            ...
            <p style="color: rgba(245, 245, 245, 0.7); font-size: 0.9em; margin-bottom: 15px;">
                Configure a taxa mínima de frete para esta rota. Esta taxa terá prioridade sobre a taxa mínima da tabela de
                frete.
            </p>
            ...
            <div
                ...
                <div>
                    ...
                    <select name="min_freight_rate_type" id="min_freight_rate_type"
                        ...
                        <option value="fixed" {{ old('min_freight_rate_type') === 'fixed' ? 'selected' : '' }}>Valor Fixo (R$)
                        </option>
                    </select>
                </div>
                <div>
            ...
            <div id="min_freight_rate_days_section" style="display: none;">
                <label style="color: var(--cor-texto-claro); display: block; margin-bottom: 8px;">Dias da Semana para
                    Aplicar Taxa Mínima</label>
                <p style="color: rgba(245, 245, 245, 0.7); font-size: 0.9em; margin-bottom: 10px;">
                    Selecione os dias da semana em que esta taxa mínima será aplicada. Se nenhum dia for selecionado, aplica
                    em todos os dias.
                </p>
