...
@section('title', 'Configurações de Aparência - TMS SaaS')
@section('page-title', 'Configurações de Aparência')
        ...
        <div class="color-picker-group">
            ...
            <div class="color-picker-wrapper">
                <input 
                    ...
                    id="primary_color" 
                    name="primary_color" 
                    value="{{ $tenant->primary_color ?? '#245a49' }}" 
        ...
        <div class="color-picker-group">
            ...
            <div class="color-picker-wrapper">
                <input 
                    ...
                    value="{{ $tenant->secondary_color ?? '#1a3d33' }}" 
                    class="color-picker-input"
        ...
        <div class="color-picker-group">
            ...
            <div class="color-picker-wrapper">
                <input 
                    ...
                    id="accent_color" 
                    name="accent_color" 
                    value="{{ $tenant->accent_color ?? '#FF6B35' }}" 
                    class="color-picker-input"
