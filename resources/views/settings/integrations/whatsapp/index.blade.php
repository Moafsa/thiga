                ...
                <div class="integration-item" data-integration-id="{{ $integration->id }}">
                    ...
                    <div class="actions">
                        ...
                        @if($integration->isConnected())
                            <form method="POST" action="{{ route('settings.integrations.whatsapp.logout', $integration) }}" onsubmit="return confirm('Isso irá desconectar o WhatsApp. Você precisará escanear o QR Code novamente para reconectar. Continuar?');">
                                @csrf
                                <button type="submit" class="btn btn-secondary">
