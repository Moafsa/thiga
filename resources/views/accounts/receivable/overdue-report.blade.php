            ...
            <div class="bg-red-50 rounded-lg shadow-md p-6 border-l-4 border-red-600">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-red-600">{{ $totalCount }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-red-50 rounded-lg shadow-md p-6 border-l-4 border-red-600">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-red-600">R$ {{ number_format($totalOverdue, 2, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @forelse($overdueInvoices as $invoice)
                            ...
                            <tr class="hover:bg-red-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500">{{ $invoice->client->cnpj }}</div>
                                </td>
