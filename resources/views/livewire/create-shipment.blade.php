            ...
            @for($i = 1; $i <= $totalSteps; $i++)
                <div style="display: flex; align-items: center; flex: 1;">
                    <div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
                        <div style="width: 50px; height: 50px; border-radius: 50%; background-color: {{ $step >= $i ? 'var(--cor-acento)' : 'rgba(255, 255, 255, 0.2)' }}; color: {{ $step >= $i ? 'var(--cor-principal)' : 'rgba(245, 245, 245, 0.5)' }}; display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: 1.2em; margin-bottom: 10px;">
                            @if($step > $i)
                    ...
                    @if($i < $totalSteps)
                        <div style="flex: 1; height: 2px; background-color: {{ $step > $i ? 'var(--cor-acento)' : 'rgba(255, 255, 255, 0.2)' }}; margin: 0 10px; margin-top: -30px;"></div>
                    @endif
                </div>
            @endfor
        </div>
            ...
            <form wire:submit.prevent="nextStep">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px; margin-bottom: 20px;">
                    <div class="filter-group">
                        ...
                        @error('sender_client_id') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="text" wire:model="receiver_name" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('receiver_name') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-bottom: 20px;">
                    <div class="filter-group" style="grid-column: span 3;">
                        ...
                        <input type="text" wire:model="pickup_address" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('pickup_address') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="text" wire:model="pickup_city" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('pickup_city') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        @error('pickup_state') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="text" wire:model="pickup_zip_code" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('pickup_zip_code') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-bottom: 30px;">
                    <div class="filter-group" style="grid-column: span 3;">
                        ...
                        <input type="text" wire:model="delivery_address" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('delivery_address') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="text" wire:model="delivery_city" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('delivery_city') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        @error('delivery_state') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="text" wire:model="delivery_zip_code" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('delivery_zip_code') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-bottom: 30px;">
                    <div class="filter-group">
                        ...
                        <input type="date" wire:model="pickup_date" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('pickup_date') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="date" wire:model="delivery_date" required
                               style="width: 100%; padding: 10px 15px; background-color: var(--cor-principal); border: 2px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: var(--cor-texto-claro); font-size: 0.95em;">
                        @error('delivery_date') <span style="color: #f44336; font-size: 0.85em;">{{ $message }}</span> @enderror
                    </div>
                ...
                <div style="background-color: var(--cor-principal); padding: 20px; border-radius: 10px; margin-bottom: 20px;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px;">
                        @if(isset($freight_calculation_result['weight_breakdown']))
                            <div>
                                ...
                                <div style="color: var(--cor-texto-claro); font-weight: 600;">R$ {{ number_format($freight_calculation_result['weight_breakdown']['total'] ?? 0, 2, ',', '.') }}</div>
                            </div>
                        @endif
                        @if(isset($freight_calculation_result['ad_valorem']))
                            <div>
                                <span style="color: rgba(245, 245, 245, 0.7); font-size: 0.9em;">Ad Valorem:</span>
                                <div style="color: var(--cor-texto-claro); font-weight: 600;">R$ {{ number_format($freight_calculation_result['ad_valorem'], 2, ',', '.') }}</div>
                            </div>
                        @endif
                        @if(isset($freight_calculation_result['gris']))
                            <div>
                                <span style="color: rgba(245, 245, 245, 0.7); font-size: 0.9em;">GRIS:</span>
                                <div style="color: var(--cor-texto-claro); font-weight: 600;">R$ {{ number_format($freight_calculation_result['gris'], 2, ',', '.') }}</div>
                            </div>
                        @endif
                        @if(isset($freight_calculation_result['toll']))
                            <div>
                                <span style="color: rgba(245, 245, 245, 0.7); font-size: 0.9em;">Pedágio:</span>
                                <div style="color: var(--cor-texto-claro); font-weight: 600;">R$ {{ number_format($freight_calculation_result['toll'], 2, ',', '.') }}</div>
                            </div>
                        @endif
                        @if(isset($freight_calculation_result['ctrc']))
                            <div>
                                <span style="color: rgba(245, 245, 245, 0.7); font-size: 0.9em;">CTRC:</span>
                                <div style="color: var(--cor-texto-claro); font-weight: 600;">R$ {{ number_format($freight_calculation_result['ctrc'], 2, ',', '.') }}</div>
                            </div>
                        @endif
                    </div>
                    <div style="margin-top: 20px; padding-top: 20px; border-top: 2px solid rgba(255, 107, 53, 0.3);">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span style="color: var(--cor-acento); font-size: 1.5em; font-weight: 700;">R$ {{ number_format($freight_value ?? 0, 2, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
            @endif
