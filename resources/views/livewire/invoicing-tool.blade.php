            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-bottom: 15px;">
                ...
                <div class="filter-group">
                    ...
                    @error('selectedClientId') 
                        <span style="color: #f44336; font-size: 0.85em; margin-top: 5px; display: block;">{{ $message }}</span> 
                    @enderror
                </div>
        ...
        <div class="card">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h2 style="color: var(--cor-acento); font-size: 1.3em;">
                    ...
                    Cargas Disponíveis para Faturamento ({{ count($availableShipments) }})
                </h2>
                ...
                <table>
                    ...
                    <tbody>
                        @foreach($availableShipments as $shipment)
                            <tr style="{{ in_array($shipment['id'], $selectedShipments) ? 'background-color: rgba(76, 175, 80, 0.1);' : '' }}">
                                ...
                                <td>
                                    <span style="font-family: monospace; font-weight: 600;">{{ $shipment['tracking_number'] }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="status-badge" style="background-color: {{ $shipment['cte_status'] === 'Autorizado' ? 'rgba(76, 175, 80, 0.2)' : 'rgba(255, 193, 7, 0.2)' }}; color: {{ $shipment['cte_status'] === 'Autorizado' ? '#4caf50' : '#ffc107' }};">
                                        {{ $shipment['cte_status'] }}
                                    </span>
                                </td>
                            </tr>
            ...
            <div style="margin-top: 20px; display: flex; justify-content: flex-end;">
                <button wire:click="generateInvoice" 
                    ...
                    <span wire:loading.remove wire:target="generateInvoice">
                        ...
                        Gerar Fatura ({{ count($selectedShipments) }} selecionadas)
                    </span>
